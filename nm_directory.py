...
CORRECTIONS_V10 = [
    ...
    " notes = 'well drilling is outside ECC scope — subcontract to an OSE-licensed driller; new wells only; driller license coordinator nm.driller@ose.nm.gov (verify contact)'"
