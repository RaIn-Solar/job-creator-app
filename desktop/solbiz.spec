...
"""PyInstaller build recipe for Solbiz Desktop.

Run from the repository root:  pyinstaller desktop/solbiz.spec
Produces dist/Solbiz/ — a self-contained folder (Solbiz.exe on Windows)
...
run_solbiz entry point; they're also listed as hiddenimports for safety.
"""
...
a = Analysis(
    [os.path.join(SPECPATH, 'run_solbiz.py')],
    ...
    hookspath=[],
    runtime_hooks=[],
    # Solbiz is pure Flask + SQLite and imports none of these; excluding
